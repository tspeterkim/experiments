...
'''
* Observed that topk is not a single kernel - many kernels called in sequence.
'''

with profile(activities=[ProfilerActivity.CPU, ProfilerActivity.CUDA], record_shapes=True, profile_memory=True, with_stack=True,
